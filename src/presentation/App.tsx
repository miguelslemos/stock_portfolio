...
export function App() {
  ...
  return (
    <div className="mx-auto max-w-6xl overflow-hidden rounded-2xl border border-surface-200/50 bg-surface-0 shadow-xl dark:border-surface-800 dark:bg-surface-900">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-surface-500 dark:text-surface-400">
                  ...
                  Ou se preferir, informe o <strong className="text-surface-700 dark:text-surface-300">saldo inicial</strong> de um ano anterior e insira apenas as operações a partir desse ponto.
                </p>
              </div>
      ...
      <a
        href="https://forms.gle/TC16cKMo21C7hvZS9"
        target="_blank"
        rel="noopener noreferrer"
        onClick={handleFeedback}
        className="fixed bottom-6 right-6 z-50 flex items-center gap-2 rounded-full bg-brand-600 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-brand-600/30 transition-all hover:bg-brand-700 hover:shadow-xl hover:shadow-brand-600/40 active:scale-95 dark:bg-brand-500 dark:shadow-brand-500/20 dark:hover:bg-brand-400"
      >
