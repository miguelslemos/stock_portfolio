  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <span className={`text-[10px] font-medium transition-opacity ${copied ? 'text-emerald-600 opacity-100 dark:text-emerald-400' : 'text-surface-400 opacity-0 group-hover:opacity-100'}`}>
          {copied ? (
            'Copiado!'
          ) : (
