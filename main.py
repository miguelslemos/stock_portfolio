...
def main():
    try:
        # Reading data from manual entries
        # benecify_history = BenefitHistory(data_provider=MultDataProvider(providers=[StaticDataProvider(operations = [
        #     VestingOperation(
        ...
        # Reading operations from PDF confirmations
