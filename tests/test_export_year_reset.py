...
class TestExportYearReset:
    ...
    def test_csv_export_shows_year_resets(self, multi_year_positions):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            for row in rows:
                ...
                profit_str = row['Gross Profit BRL']
                profit = float(profit_str.split()[0])  # Split by space and take the numeric part
    ...
    def test_export_with_single_year_no_reset(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            profits = [float(row['Gross Profit BRL'].split()[0]) for row in rows]
    ...
    def test_export_with_positions_missing_operation_info(self):
        ...
        positions = [
            PortfolioPosition(
                ...
                gross_profit_brl=ProfitLoss(Decimal('200.00'), 'BRL'),
